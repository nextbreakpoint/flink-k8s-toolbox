...
object FlinkServerUtils {
    private val logger = Logger.getLogger(FlinkServerUtils::class.simpleName)
    ...
    fun find(flinkOptions: FlinkOptions, namespace: String, clusterName: String): FlinkApi {
        ...
        if (flinkOptions.hostname == null && flinkOptions.portForward == null && flinkOptions.useNodePort) {
            val nodes = KubernetesUtils.coreApi.listNode(
                false,
                null,
                null,
                null,
        ...
        if (flinkOptions.portForward == null) {
            val call = KubernetesUtils.objectApi.getNamespacedCustomObjectCall(
                "nextbreakpoint.com",
                "v1",
                namespace,
                "flinkclusters",
            ...
            response.body().use {
                ...
                val pods = KubernetesUtils.coreApi.listNamespacedPod(
                    namespace,
                    null,
                    null,
                    null,
