...
docker tag integration/flinkctl:1.4.0-beta $(minikube ip):5000/flinkctl:1.4.0-beta
...
docker push $(minikube ip):5000/flinkctl:1.4.0-beta
docker push $(minikube ip):5000/flink:1.9.2
docker push $(minikube ip):5000/jobs:latest

eval $(minikube docker-env)

docker tag $(minikube ip):5000/flinkctl:1.4.0-beta integration/flinkctl:1.4.0-beta
