...
class ClusterStopJobs(flinkOptions: FlinkOptions, flinkClient: FlinkClient, kubeClient: KubeClient) : Action<Set<String>, Boolean>(flinkOptions, flinkClient, kubeClient) {
    companion object {
    ...
    override fun execute(clusterSelector: ResourceSelector, params: Set<String>): Result<Boolean> {
        try {
