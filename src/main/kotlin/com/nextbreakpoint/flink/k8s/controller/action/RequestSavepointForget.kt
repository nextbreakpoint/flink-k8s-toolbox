...
class RequestSavepointForget(flinkOptions: FlinkOptions, flinkClient: FlinkClient, kubeClient: KubeClient, private val context: JobContext) : Action<Void?, Void?>(flinkOptions, flinkClient, kubeClient) {
    companion object {
    ...
    override fun execute(jobSelector: ResourceSelector, params: Void?): Result<Void?> {
        return try {
            context.setJobManualAction(ManualAction.FORGET_SAVEPOINT)
            ...
            logger.error("Can't forget savepoint", e)
