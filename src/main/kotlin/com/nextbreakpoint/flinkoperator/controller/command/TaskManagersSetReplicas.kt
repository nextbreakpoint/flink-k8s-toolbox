...
class TaskManagersSetReplicas(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : OperatorCommand<Int, Void?>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
