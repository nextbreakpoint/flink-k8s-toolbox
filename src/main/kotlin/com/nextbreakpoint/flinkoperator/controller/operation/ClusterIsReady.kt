...
class ClusterIsReady(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : Operation<ClusterScaling, Void?>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
