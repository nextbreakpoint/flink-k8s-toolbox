...
class ClusterIsRunning(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : Operation<Void?, Boolean>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
