...
class ClusterIsRunning(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<Void?, Boolean>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
