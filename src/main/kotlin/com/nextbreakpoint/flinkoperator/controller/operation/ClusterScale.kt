...
class ClusterScale(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext, private val cache: Cache) : Operation<ClusterScaling, List<ClusterTask>>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
