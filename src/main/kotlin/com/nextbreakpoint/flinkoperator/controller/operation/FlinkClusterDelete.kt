...
class FlinkClusterDelete(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<Void?, Void?>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
