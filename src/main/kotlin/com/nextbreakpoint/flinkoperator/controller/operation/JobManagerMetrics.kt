...
class JobManagerMetrics(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : Operation<Void?, String>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
