...
class JobMetrics(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<Void?, String>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
