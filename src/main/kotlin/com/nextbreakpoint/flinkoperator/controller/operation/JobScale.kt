...
class JobScale(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<Int, Void?>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
