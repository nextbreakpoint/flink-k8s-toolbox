...
class RequestClusterScale(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<ScaleOptions, Void?>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
