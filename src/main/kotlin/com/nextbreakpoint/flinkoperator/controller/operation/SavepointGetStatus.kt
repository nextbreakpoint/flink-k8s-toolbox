...
class SavepointGetStatus(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : Operation<SavepointRequest, String>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
