...
class SavepointGetStatus(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<SavepointRequest, String>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
