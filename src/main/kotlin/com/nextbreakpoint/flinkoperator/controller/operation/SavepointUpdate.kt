...
class SavepointUpdate(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<String, Void?>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
