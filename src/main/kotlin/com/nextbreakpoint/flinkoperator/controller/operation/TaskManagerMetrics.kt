...
class TaskManagerMetrics(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<TaskManagerId, String>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
