...
class TaskManagersGetReplicas(flinkOptions: FlinkOptions, flinkContext: FlinkContext, kubernetesContext: KubernetesContext) : TaskOperation<Void?, Int>(flinkOptions, flinkContext, kubernetesContext) {
    companion object {
