...
class RequestSavepointTrigger(flinkOptions: FlinkOptions, flinkClient: FlinkClient, kubeClient: KubeClient, private val context: ControllerContext) : Action<Void?, Void?>(flinkOptions, flinkClient, kubeClient) {
    companion object {
