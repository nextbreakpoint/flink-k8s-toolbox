...
class ClusterDeleteResources(flinkOptions: FlinkOptions) : OperatorCommand<Void?, Void?>(flinkOptions) {
    ...
    override fun execute(clusterId: ClusterId, params: Void?): Result<Void?> {
        try {
            ...
            deleteStatefulSets(Kubernetes.appsApi, "flink-operator", clusterId)

            deleteService(Kubernetes.coreApi, "flink-operator", clusterId)

            deletePersistentVolumeClaims(Kubernetes.coreApi, "flink-operator", clusterId)
