...
class StartAndStopTest : IntegrationSetup() {
    ...
    fun `should start and stop clusters`() {
        ...
        awaitUntilAsserted(timeout = 120) {
            assertThat(jobExists(namespace = namespace, name = "cluster-2-job-1")).isFalse()
            assertThat(jobExists(namespace = namespace, name = "cluster-2-job-2")).isFalse()
        }
        awaitUntilAsserted(timeout = 300) {
            assertThat(clusterExists(namespace = namespace, name = "cluster-2")).isFalse()
        }
        ...
        awaitUntilAsserted(timeout = 120) {
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-2-job-1", status = JobStatus.Stopped)).isTrue()
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-2-job-2", status = JobStatus.Stopped)).isTrue()
        }
        awaitUntilAsserted(timeout = 360) {
            assertThat(hasClusterStatus(namespace = namespace, name = "cluster-2", status = ClusterStatus.Stopped)).isTrue()
        }
        awaitUntilAsserted(timeout = 120) {
            assertThat(getTaskManagers(namespace = namespace, name = "cluster-2")).isEqualTo(0)
        }
        val savepointPath1 = getSavepointPath(namespace = namespace, name = "cluster-2-job-1")
        val savepointPath2 = getSavepointPath(namespace = namespace, name = "cluster-2-job-2")
        ...
        if (updateDeployment(namespace = namespace, name = "cluster-2", patch = "[{\"op\":\"replace\",\"path\":\"/spec/jobs/1/spec/savepoint/restartPolicy\",\"value\":\"Always\"}]") != 0) {
        ...
        val savepointPath3 = getSavepointPath(namespace = namespace, name = "cluster-2-job-1")
        val savepointPath4 = getSavepointPath(namespace = namespace, name = "cluster-2-job-2")
        ...
        if (updateDeployment(namespace = namespace, name = "cluster-2", patch = "[{\"op\":\"replace\",\"path\":\"/spec/jobs/0/spec/savepoint/restartPolicy\",\"value\":\"Always\"}]") != 0) {
            fail("Can't update deployment")
        }
        ...
        val savepointPath5 = getSavepointPath(namespace = namespace, name = "cluster-2-job-1")
        val savepointPath6 = getSavepointPath(namespace = namespace, name = "cluster-2-job-2")
    ...
    fun `should start and stop jobs`() {
        ...
        awaitUntilAsserted(timeout = 120) {
            assertThat(jobExists(namespace = namespace, name = "cluster-1-job-0")).isFalse()
        }
        awaitUntilAsserted(timeout = 300) {
            assertThat(clusterExists(namespace = namespace, name = "cluster-1")).isFalse()
        }
        ...
        if (updateDeployment(namespace = namespace, name = "cluster-1", patch = "[{\"op\":\"replace\",\"path\":\"/spec/jobs/0/spec/savepoint/restartPolicy\",\"value\":\"Always\"}]") != 0) {
            fail("Can't update deployment")
        }
        ...
        awaitUntilAsserted(timeout = 120) {
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-1-job-0", status = JobStatus.Stopped)).isTrue()
        }
        val savepointPath1 = getSavepointPath(namespace = namespace, name = "cluster-1-job-0")
        ...
        val savepointPath2 = getSavepointPath(namespace = namespace, name = "cluster-1-job-0")
        ...
        val savepointPath3 = getSavepointPath(namespace = namespace, name = "cluster-1-job-0")
        assertThat(savepointPath3).isEqualTo(savepointPath1)
        ...
        val savepointPath4 = getSavepointPath(namespace = namespace, name = "cluster-1-job-0")
    ...
    fun `should stop job when job fails`() {
        ...
        if (updateDeployment(namespace = namespace, name = "cluster-1", patch = "[{\"op\":\"replace\",\"path\":\"/spec/jobs/0/spec/savepoint/restartPolicy\",\"value\":\"Always\"},{\"op\":\"replace\",\"path\":\"/spec/jobs/0/spec/bootstrap/image\",\"value\":\"wrong/flink-jobs:1\"}]") != 0) {
            fail("Can't update deployment")
        }
        awaitUntilAsserted(timeout = 60) {
        ...
        awaitUntilAsserted(timeout = 180) {
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-1-job-0", status = JobStatus.Starting)).isTrue()
        }
        awaitUntilAsserted(timeout = 360) {
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-1-job-0", status = JobStatus.Stopped)).isTrue()
        }
        ...
        if (updateDeployment(namespace = namespace, name = "cluster-1", patch = "[{\"op\":\"replace\",\"path\":\"/spec/jobs/0/spec/bootstrap/image\",\"value\":\"integration/flink-jobs:1\"}]") != 0) {
            fail("Can't update deployment")
        }
        awaitUntilAsserted(timeout = 180) {
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-1-job-0", status = JobStatus.Starting)).isTrue()
        ...
        println("Should stop job when specification changed and job failed...")
        if (updateDeployment(namespace = namespace, name = "cluster-1", patch = "[{\"op\":\"replace\",\"path\":\"/spec/jobs/0/spec/bootstrap/className\",\"value\":\"wrongclassname\"}]") != 0) {
            fail("Can't update deployment")
        }
        awaitUntilAsserted(timeout = 60) {
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-1-job-0", status = JobStatus.Stopping)).isTrue()
        ...
        println("Should restart job when specification changed...")
        if (updateDeployment(namespace = namespace, name = "cluster-1", patch = "[{\"op\":\"replace\",\"path\":\"/spec/jobs/0/spec/bootstrap/className\",\"value\":\"com.nextbreakpoint.flink.jobs.stream.TestJob\"}]") != 0) {
            fail("Can't update deployment")
        }
        awaitUntilAsserted(timeout = 180) {
            assertThat(hasJobStatus(namespace = namespace, name = "cluster-1-job-0", status = JobStatus.Starting)).isTrue()
