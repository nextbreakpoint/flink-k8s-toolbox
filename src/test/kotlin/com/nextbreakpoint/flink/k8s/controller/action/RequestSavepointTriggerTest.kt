...
class RequestSavepointTriggerTest {
    ...
    private val command = RequestSavepointTrigger(flinkOptions, flinkClient, kubeClient, context)
    ...
    fun `should trigger savepoint`() {
        ...
        assertThat(result.output).isNull()
        assertThat(FlinkJobAnnotations.getManualAction(job)).isEqualTo(ManualAction.TRIGGER_SAVEPOINT)
