...
class ClusterIsRunningTest {
    ...
    private val command = ClusterIsRunning(flinkOptions, flinkContext, kubernetesContext)
    ...
    @Test
    fun `should return expected result when there aren't task slots`() {
        val overview = ClusterOverviewWithVersion()
        overview.slotsTotal = 0
    ...
    @Test
    fun `should return expected result when there aren't finished jobs`() {
        val overview = ClusterOverviewWithVersion()
        overview.slotsTotal = 1
        overview.taskmanagers = 1
        overview.jobsRunning = 0
    ...
    @Test
    fun `should return expected result when there are task managers, task slots and running jobs`() {
        val overview = ClusterOverviewWithVersion()
        overview.slotsTotal = 1
        overview.taskmanagers = 1
        overview.jobsRunning = 1
    ...
    @Test
    fun `should return expected result when there are task managers, task slots and finished jobs`() {
        val overview = ClusterOverviewWithVersion()
        overview.slotsTotal = 1
        overview.taskmanagers = 1
        overview.jobsRunning = 0
