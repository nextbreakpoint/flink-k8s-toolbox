...
class ClusterIsSuspendedTest {
    ...
    private val command = ClusterIsSuspended(flinkOptions, flinkContext, kubernetesContext)
    ...
    @Test
    fun `should return expected result when there are task managers and task slots but no running jobs`() {
        val overview = ClusterOverviewWithVersion()
        overview.slotsTotal = 1
        overview.taskmanagers = 1
        overview.jobsRunning = 0
