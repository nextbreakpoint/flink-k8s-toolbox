...
class RequestSavepointTriggerTest {
    ...
    private val command = RequestSavepointTrigger(flinkOptions, flinkClient, kubeClient, supervisorContext)
    ...
    fun `should trigger savepoint`() {
        ...
        assertThat(result.output).isNull()
        assertThat(Annotations.getManualAction(cluster)).isEqualTo(ManualAction.TRIGGER_SAVEPOINT)
